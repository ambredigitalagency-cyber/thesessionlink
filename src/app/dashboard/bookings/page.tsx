...
export default async function BookingsPage() {
  ...
  const { data } = await supabase
    .from("bookings")
    .select(
      "id, offer_title, action_type, client_id, client_name, client_email, client_phone, client_message, starts_at, ends_at, requested_date, quantity, status, internal_notes, details, created_at",
    )
